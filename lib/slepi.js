...
function readPanelRows() {
  ...
  const rows = lines.slice(1).map((line) => {
    ...
    return {
      ...
      external_financing_pressure_z: pickF("external_financing_pressure_z"),
      current_account_pressure_z: pickF("current_account_pressure_z"),
      slepi_adjusted: pickF("slepi_adjusted"),
      usd_lkr: pickF("usd_lkr"),
      import_cover_months: pickF("import_cover_months"),
      adjusted_usable_reserve_cover_months: pickF("adjusted_usable_reserve_cover_months"),
      adjusted_usable_reserves_usd_m: pickF("adjusted_usable_reserves_usd_m"),
      short_term_external_debt_to_reserves_raw: pickF("short_term_external_debt_to_reserves_raw"),
      current_account_filled_usd_m: pickF("current_account_filled_usd_m"),
      current_account_pressure_raw: pickF("current_account_pressure_raw"),
      current_account_pressure_quality: pickF("current_account_pressure_quality"),
      trade_balance_usd_m: pickF("trade_balance_usd_m"),
      buffer_inflows_usd_m: pickF("buffer_inflows_usd_m"),
      services_balance_usd_m: pickF("services_balance_usd_m"),
      m2b_to_adjusted_reserves_raw: pickF("m2b_to_adjusted_reserves_raw"),
    };
  });
...
export function getStatHistory(length = 18) {
  ...
  return rows
    ...
    .map((r) => ({
      ...
      adjusted_usable_reserve_cover_months: r.adjusted_usable_reserve_cover_months,
      short_term_external_debt_to_reserves_raw: r.short_term_external_debt_to_reserves_raw,
      current_account_filled_usd_m: r.current_account_filled_usd_m,
      current_account_pressure_raw: r.current_account_pressure_raw,
      trade_balance_usd_m: r.trade_balance_usd_m,
      buffer_inflows_usd_m: r.buffer_inflows_usd_m,
      services_balance_usd_m: r.services_balance_usd_m,
      m2b_to_adjusted_reserves_raw: r.m2b_to_adjusted_reserves_raw,
    }));
}
